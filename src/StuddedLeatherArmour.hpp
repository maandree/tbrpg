...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual StuddedLeatherArmour& operator =(const StuddedLeatherArmour& original);
     ...
     */
    virtual bool operator ==(const StuddedLeatherArmour& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::StuddedLeatherArmour*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::StuddedLeatherArmour* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::StuddedLeatherArmour*>(elem)->hash();
    }
  };
}
