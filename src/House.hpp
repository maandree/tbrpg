...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual House& operator =(const House& original);
     ...
     */
    virtual bool operator ==(const House& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::House*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::House* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::House*>(elem)->hash();
    }
  };
}
