...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual FullPlateMail& operator =(const FullPlateMail& original);
     ...
     */
    virtual bool operator ==(const FullPlateMail& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::FullPlateMail*>(&elem)->hash();
    }
  };
