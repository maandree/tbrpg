...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const Bolt& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::Bolt*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::Bolt* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::Bolt*>(elem)->hash();
    }
  };
}
