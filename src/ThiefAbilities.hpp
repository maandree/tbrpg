...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const ThiefAbilities& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::ThiefAbilities*>(&elem)->hash();
    }
  };
  ...
  public:
    ...
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::ThiefAbilities*>(elem)->hash();
    }
  };
}
