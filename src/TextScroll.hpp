...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const TextScroll& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::TextScroll*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::TextScroll* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::TextScroll*>(elem)->hash();
    }
  };
}
