...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const HalfOrc& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::HalfOrc*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::HalfOrc* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::HalfOrc*>(elem)->hash();
    }
  };
}
