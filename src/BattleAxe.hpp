...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual BattleAxe& operator =(const BattleAxe& original);
     ...
     */
    virtual bool operator ==(const BattleAxe& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::BattleAxe*>(&elem)->hash();
    }
  };
  ...
  public:
    ...
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::BattleAxe*>(elem)->hash();
    }
  };
}
