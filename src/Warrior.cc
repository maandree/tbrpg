...
namespace tbrpg
{
  ...
  Warrior::Warrior() : Class()
  {
    ...
    this->can_use[new CompositeLongBow()] = true;
    this->can_use[new LongBow()] = true;
    this->can_use[new ShortBow()] = true;
    this->can_use[new HeavyCrossbow()] = true;
    this->can_use[new LightCrossbow()] = true;
    this->can_use[new ThrowingAxe()] = true;
