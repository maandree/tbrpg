...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const Potion& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::Potion*>(&elem)->hash();
    }
  };
  ...
  public:
    ...
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::Potion*>(elem)->hash();
    }
  };
}
