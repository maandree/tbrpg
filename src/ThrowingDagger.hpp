...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual ThrowingDagger& operator =(const ThrowingDagger& original);
     ...
     */
    virtual bool operator ==(const ThrowingDagger& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<ThrowingDagger*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::ThrowingDagger* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<ThrowingDagger*>(elem)->hash();
    }
  };
}
