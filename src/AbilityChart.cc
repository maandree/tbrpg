...
namespace tbrpg
{
  ...
  size_t AbilityChart::hash() const
  {
    ...
    rc += std::hash<AbilityBonus*>()(this->strength);
    rc = (rc * 5) ^ ((rc >> (sizeof(size_t) << 2)) * 5);
    rc += std::hash<AbilityBonus*>()(this->strength18);
    rc = (rc * 7) ^ ((rc >> (sizeof(size_t) << 2)) * 7);
    rc += std::hash<AbilityBonus*>()(this->dexterity);
    rc = (rc * 9) ^ ((rc >> (sizeof(size_t) << 2)) * 9);
    rc += std::hash<AbilityBonus*>()(this->constitution);
    rc = (rc * 11) ^ ((rc >> (sizeof(size_t) << 2)) * 11);
    rc += std::hash<AbilityBonus*>()(this->intelligence);
    rc = (rc * 13) ^ ((rc >> (sizeof(size_t) << 2)) * 13);
    rc += std::hash<AbilityBonus*>()(this->wisdom);
    rc = (rc * 17) ^ ((rc >> (sizeof(size_t) << 2)) * 17);
    rc += std::hash<AbilityBonus*>()(this->charisma);
    return rc;
  }
