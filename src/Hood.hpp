...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const Hood& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::Hood*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::Hood* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::Hood*>(elem)->hash();
    }
  };
}
