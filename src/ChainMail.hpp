...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const ChainMail& other) const;
...
{
  template<>
  class hash<tbrpg::ChainMail>
  {
  public:
    size_t operator()(const tbrpg::ChainMail& elem) const
    {
      return dynamic_cast<const tbrpg::ChainMail*>(&elem)->hash();
    }
  };
