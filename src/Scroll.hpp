...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const Scroll& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<Scroll*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::Scroll* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<Scroll*>(elem)->hash();
    }
  };
}
