...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual LongSword& operator =(const LongSword& original);
...
namespace std
{
  ...
  {
  public:
    size_t operator()(const tbrpg::LongSword& elem) const
    {
      return dynamic_cast<const tbrpg::LongSword*>(&elem)->hash();
    }
  };
  ...
  public:
    ...
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::LongSword*>(elem)->hash();
    }
  };
}


#endif//__GUARD_LONGSWORD_HPP__
