...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const Gem& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::Gem*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::Gem* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::Gem*>(elem)->hash();
    }
  };
}


#endif//__GUARD_GEM_HPP__
