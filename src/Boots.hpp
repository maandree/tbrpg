...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const Boots& other) const;
...
{
  template<>
  class hash<tbrpg::Boots>
  {
  public:
    size_t operator()(const tbrpg::Boots& elem) const
    {
      return dynamic_cast<const tbrpg::Boots*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::Boots* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::Boots*>(elem)->hash();
    }
  };
}
