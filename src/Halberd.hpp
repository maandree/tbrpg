...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual Halberd& operator =(const Halberd& original);
     ...
     */
    virtual bool operator ==(const Halberd& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::Halberd*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::Halberd* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::Halberd*>(elem)->hash();
    }
  };
}
