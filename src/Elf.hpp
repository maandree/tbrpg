...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const Elf& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::Elf*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::Elf* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::Elf*>(elem)->hash();
    }
  };
}


#endif//__GUARD_ELF_HPP__
