...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const MediumShield& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::MediumShield*>(&elem)->hash();
    }
  };
  ...
  public:
    ...
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::MediumShield*>(elem)->hash();
    }
  };
}
