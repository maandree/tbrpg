...
namespace tbrpg
{
  ...
  public:
     ...
     */
    virtual bool operator ==(const WarHammer& other) const;
...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::WarHammer*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::WarHammer* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::WarHammer*>(elem)->hash();
    }
  };
}
