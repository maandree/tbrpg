...
namespace std
{
  ...
  public:
    ...
    {
      return dynamic_cast<const tbrpg::Throwing*>(&elem)->hash();
    }
  };
  ...
  {
  public:
    size_t operator()(tbrpg::Throwing* elem) const
    {
      return elem == nullptr ? 0 : dynamic_cast<tbrpg::Throwing*>(elem)->hash();
    }
  };
}
